...
const COLORS = {
    ...
    labelMuted: "#6C8C7C",
    labelFaint: "#95B2A2",
    shadow: "rgba(45,106,79,.08)",
};

const CARD_SHADOW = `
0 10px 30px rgba(0,0,0,.04),
0 3px 10px rgba(45,106,79,.05)
`;
...
const STAR_DESCRIPTION: Record<string, string> = {
    S: "Background",
    T: "Objective",
    A: "Execution",
    R: "Outcome",
    ...
    return (
        ...
        <div
            style={{
                ...
                background:
                    "linear-gradient(180deg,#F4FBF7,#E5F3EC)",
    ...
    return (
        ...
        <div
            style={{
                ...
                borderRadius: `${SECTION_RADIUS}px`,
