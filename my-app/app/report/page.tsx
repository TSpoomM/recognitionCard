                  ...
                  <div className="grid gap-6 xl:grid-cols-[1fr_1fr_220px]">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {(data?.branches || []).map((branch) => {
                          ...
                          return (
                            <label
                              key={branch}
                              className={`flex cursor-pointer items-center gap-2 rounded-full border px-4 py-2 text-base transition ${active
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="mb-3 w-full rounded-xl border border-slate-200 px-3 py-2 text-lg"
                      />
                        ...
                        {employees.map((employee) => {
                          ...
                          return (
                            <label
                              ...
                              className={`mb-1 flex cursor-pointer items-center gap-2 rounded-lg px-2 py-2 ${active ? "bg-slate-100" : "hover:bg-slate-50"
                                }`}
                            >
                              <input
                                type="checkbox"
                              ...
                              <span className="text-lg flex-1 truncate">
                                {employee.name}
                              </span>
